...
const Info = () => {
  ...
  const content = [
    ...
    {
      question: "Q. 본인만의 강점은 무엇인지?",
      answer: (
        <>
          프론트엔드 분야 특성 상 모든 분야의 팀원과의 소통이 중요하다고 생각합니다.
          <br />
          Design, Backend 분야의 사람들과 프로젝트를 진행 및 배포 경험이 있으며,
          <br />
          PM으로 프로젝트의 총괄을 맡아 배포한 경험 또한 있기에 팀원 간 의사소통을 막힘없이 할 수 있습니다.
          <br />
